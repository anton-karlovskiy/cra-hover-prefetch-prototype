    ...
    <article id="post">
      <section>
        <div className="img-container left column">
          <img src="https://cdn.glitch.com/8a455d85-8f99-42e6-837b-dfc94b62b2b9%2Ftech.jpg?v=1561649029571" alt="Looking up at skyscrapers" />
        </div>
        <div className="right column">
          <h2 className="headline">Tech</h2>
          <p className="content">
